...
{
    [Serializable]
    public class DamageUnityEvent : UnityEvent<DamageInfo> {}
    ...
    public void Register(UnityAction<DamageInfo> listener)
    {
        onEventRaised.AddListener(listener);
    }

    public void Unregister(UnityAction<DamageInfo> listener)
    {
